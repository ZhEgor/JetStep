package com.zhiro.jetstep.feature.locomotionclassifier.model.step2
...
import com.zhiro.jetstep.feature.locomotionclassifier.model.step5.StepFeature
import com.zhiro.jetstep.feature.locomotionclassifier.utils.algorithms.findLocalPeaksAndValleysFilter
import com.zhiro.jetstep.feature.locomotionclassifier.utils.algorithms.findPeakSimple
import com.zhiro.jetstep.feature.locomotionclassifier.utils.algorithms.findRelatedPeaksAndValleysFilter
import com.zhiro.jetstep.feature.locomotionclassifier.utils.algorithms.mapLowPassFilter
import com.zhiro.jetstep.feature.locomotionclassifier.utils.algorithms.toFeatures
import com.zhiro.jetstep.feature.locomotionclassifier.utils.printDuration
import com.zhiro.jetstep.feature.locomotionclassifier.utils.sumOf
...
internal data class StepsDetails(
    ...
    // Step 1
    private val accelerometerMagnitudeRecords: List<AccelerometerMagnitude> get() {
            return printDuration {
                ...
                val gravity = rmags.sumOf(AccelerometerMagnitude::magnitude) / rmags.size
                rmags.map { rmag ->
    ...
    // Step 2
    private val accelerometerMagnitudePeaksAndValleysRecords: List<AccelerometerMagnitude> get() {
        return printDuration {
                ...
                (peaks + valleys).sortedBy(AccelerometerMagnitude::collectedAtMillis).also {
    ...
    // Step 3
    private val accelerometerMagnitudeLocalPeaksAndValleysRecords: List<AccelerometerMagnitude> get() {
        return printDuration {
